var JsonRenderer_JsonRenderer = JsonRenderer;
import ext_chalk_chalk from "chalk";
import ext_q_Q from "q";
import ext_promptly_promptly from "promptly";
    ...
    prompts.forEach(function(prompt) {
        ...
        default:
            promise = promise.then(function() {
                throw utilcreateError_createErrorjs('Unknown prompt type', 'ENOTSUP');
            });
            return;
        }
        ...
        promise = promise.then(function() {
            ...
            return ext_q_Q.nfcall(ext_promptly_promptly[funcName], '', opts).then(function(
                answer
            ) {
...
export { JsonRenderer_JsonRenderer as JsonRenderer };
